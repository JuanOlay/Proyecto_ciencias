...
private:
    ...
    Edicion capturarDatosEdicion() {
        ...
        std::cout << "Fecha de publicación (DD/MM/YYYY): "; getline(std::cin, e.fechaPublicacion);
    ...
    void menuConsultas() {
        ...
        do {
            ...
            std::cout << "2. Obras de un autor por tipo de poesía\n";
            std::cout << "3. Autores publicados por editorial\n";
            std::cout << "4. Editoriales con más de N poetas\n";
            std::cout << "5. Autores por editorial (lugar de nacimiento)\n";
            std::cout << "6. Autores por formación y edad\n";
            std::cout << "7. Autores por tipo de poesía y editorial\n";
            ...
            switch (opcion) {
                ...
                case 4: {
                    int numeroMinimo;
                    std::cout << "Ingrese número mínimo de poetas: ";
                ...
                case 7: {
                    ...
                    limpiarBuffer();
                    std::cout << "Ingrese tipo de poesía: ";
    ...
    void menuSistema() {
        ...
        do {
            ...
            std::cout << "2. Construir índices optimizados\n";
            ...
            switch (opcion) {
                ...
                case 2: {
                    std::cout << "Construyendo índices optimizados...\n";
                    gestion.construirIndicesOptimizados();
                    std::cout << "Índices construidos exitosamente.\n";
                    break;
                }
                case 3: {
...
public:
    ...
    void mostrarMenuPrincipal() {
        ...
        if (!sistemaInicializado) {
            std::cout << "⚠️  SISTEMA NO INICIALIZADO ⚠️\n";
        }
        ...
        std::cout << "5. Sistema y Configuración\n";
        std::cout << "0. Salir\n";
        std::cout << "Seleccione una opción: ";
    }
...
void mostrarBienvenida() {
    ...
    char respuesta;
    std::cout << "¿Desea inicializar el sistema automáticamente? (S/N): ";
    std::cin >> respuesta;
    limpiarBuffer();
    ...
    if (std::toupper(respuesta) == 'S') {
        ...
        std::cout << "\nSistema no inicializado. Use la opción 'Sistema y Configuración' para inicializar.\n";
        pausar();
    }
}
    ...
    void ejecutar() {
        ...
        do {
            ...
            switch (opcion) {
                case 1: {
                    if (!sistemaInicializado) {
                        std::cout << "Debe inicializar el sistema primero (opción 5).\n";
                        pausar();
                        break;
                    }
                    menuAutores();
