...
#include "../controladores/GestionBiblioteca.h"
...
private:
    ...
    void leerCadena(char* destino, int tamano, const string& prompt);
...
Autor MenuBiblioteca::capturarDatosAutor() {
    ...
    cout << "Ano de inicio en la literatura: ";
    cin >> autor.anio_inicio_literatura;
    
    cout << "Ano de publicación de su primera obra: ";
...
void MenuBiblioteca::leerCadena(char* destino, int tamano, const string& prompt) {
    cout << prompt;
    cin.ignore();
